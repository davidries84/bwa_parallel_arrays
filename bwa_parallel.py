...
def write_array_file_singlereads(path_to_bwa, path_to_samtools, path_to_reference, name_split_file, path_to_splitFiles, threads, number_splits):
	...
	mapping_cmd1 = path_to_bwa + " mem -M  -t " + str(threads) + " " + path_to_reference + " " + os.path.abspath(fw_splitted_files) + " | " + "/vol/biotools/bin/samtools view -bS - |  /vol/biotools/bin/samtools sort -m 200000000 - -o " +  bamFile1
